...
export default function PostPurchaseUpsell() {
  ...
  // Fallback: resolve order_id by payment intent id if needed
  useEffect(() => {
    let stopped = false;
...
export default function PostPurchaseUpsell() {
  ...
  const handleAccept = async () => {
    setIsProcessing(true);
    // Simulate payment processing (WooCommerce integration will handle this)
    await new Promise((resolve) => setTimeout(resolve, 1500));
    // TODO: Add to WooCommerce order
    navigate("/thank-you");
  };
